      ...
      <section className="relative bg-zinc-950 py-24 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black uppercase tracking-widest text-white mb-4">The <span className="text-red-600">Lab</span> Ecosystem</h2>
            <p className="text-gray-500 font-light">Interactive environments designed for rapid Stellar mastery.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Link href="/simulator" className="bg-black border border-white/10 hover:border-red-500/50 rounded-2xl p-8 transition-all hover:-translate-y-2 group">
              <div className="w-14 h-14 bg-red-500/10 rounded-xl flex items-center justify-center mb-6 border border-red-500/20 group-hover:bg-red-600 transition-colors">
                <svg className="w-7 h-7 text-red-500 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
              </div>
              <h3 className="text-xl font-bold text-white mb-3 uppercase tracking-tight">Simulator</h3>
              <p className="text-xs text-gray-500 leading-relaxed font-light mb-4">Observe live Stellar ledger activity in a terminal-themed visualization.</p>
              <span className="text-[10px] font-black text-red-500 uppercase tracking-widest group-hover:pl-2 transition-all">Enter →</span>
            </Link>

            <Link href="/playground" className="bg-black border border-white/10 hover:border-red-500/50 rounded-2xl p-8 transition-all hover:-translate-y-2 group">
              <div className="w-14 h-14 bg-white/5 rounded-xl flex items-center justify-center mb-6 border border-white/10 group-hover:bg-white group-hover:text-black transition-colors">
                <svg className="w-7 h-7 text-white group-hover:text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>
              </div>
              <h3 className="text-xl font-bold text-white mb-3 uppercase tracking-tight">Playground</h3>
              <p className="text-xs text-gray-500 leading-relaxed font-light mb-4">Compile and execute Soroban smart contract logic in a sandboxed environment.</p>
              <span className="text-[10px] font-black text-white uppercase tracking-widest group-hover:pl-2 transition-all">Execute →</span>
            </Link>

            <Link href="/roadmap" className="bg-black border border-white/10 hover:border-red-500/50 rounded-2xl p-8 transition-all hover:-translate-y-2 group">
              <div className="w-14 h-14 bg-red-500/10 rounded-xl flex items-center justify-center mb-6 border border-red-500/20 group-hover:bg-red-600 transition-colors">
                <svg className="w-7 h-7 text-red-500 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 002 2h2a2 2 0 002-2" /></svg>
              </div>
              <h3 className="text-xl font-bold text-white mb-3 uppercase tracking-tight">Roadmap</h3>
              <p className="text-xs text-gray-500 leading-relaxed font-light mb-4">Track your progression through the multi-stage Stellar mastery tree.</p>
              <span className="text-[10px] font-black text-red-500 uppercase tracking-widest group-hover:pl-2 transition-all">Visualize →</span>
            </Link>

            <Link href="/ideas" className="bg-black border border-white/10 hover:border-red-500/50 rounded-2xl p-8 transition-all hover:-translate-y-2 group">
              <div className="w-14 h-14 bg-white/5 rounded-xl flex items-center justify-center mb-6 border border-white/10 group-hover:bg-white group-hover:text-black transition-colors">
              ...
              <h3 className="text-xl font-bold text-white mb-3 uppercase tracking-tight">Incubator</h3>
              <p className="text-xs text-gray-500 leading-relaxed font-light mb-4">Generate heuristically optimized project concepts for your next build.</p>
              <span className="text-[10px] font-black text-white uppercase tracking-widest group-hover:pl-2 transition-all">Initialize →</span>
            </Link>
          </div>
        </div>
      </section>
